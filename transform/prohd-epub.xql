                    ...
                    case element(choice) return
                        if ($parameters?mode='norm' and sic and corr) then
                            ...
                            if (sic and corr) then
                                (
                                    epub:alternate($config, ., ("tei-choice5", "choice", css:map-rend-to-class(.)), ., sic[1], corr[1]),
                                    epub:alternate($config, ., ("tei-choice6", "choice-alternate", css:map-rend-to-class(.)), ., (), corr[1])
                                )
                                ...
                                if ($parameters?mode='norm' and abbr and expan) then
                                    ...
                                    if (abbr and expan) then
                                        (
                                            epub:alternate($config, ., ("tei-choice8", "choice", css:map-rend-to-class(.)), ., abbr[1], expan[1]),
                                            epub:alternate($config, ., ("tei-choice9", "choice-alternate", css:map-rend-to-class(.)), ., (), abbr[1])
                                        )

                                    else
                                        if ($parameters?mode='norm' and orig and reg) then
                                            epub:alternate($config, ., ("tei-choice10", "choice", css:map-rend-to-class(.)), ., reg[1], orig[1])
                                        else
                                            if (orig and reg) then
                                                (
                                                    epub:alternate($config, ., ("tei-choice11", "choice", css:map-rend-to-class(.)), ., orig[1], reg[1]),
                                                    epub:alternate($config, ., ("tei-choice12", "choice-alternate", css:map-rend-to-class(.)), ., (), orig[1])
                                                )
